...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "config.backend": "推理引擎:",
    "config.backendStandard": "普通 (Zipformer Transducer)",
    "config.backendHybrid": "混合推理 (Zipformer CTC + SenseVoice)",
  ...
  en: {
    ...
    "config.backendStandard": "Standard (Zipformer Transducer)",
    "config.backendHybrid": "Hybrid (Zipformer CTC + SenseVoice)",
