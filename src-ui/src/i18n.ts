...
const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "config.backend": "推理引擎:",
    "config.backendStandard": "标准",
    "config.backendHybrid": "混合",
    "config.backendHint": "标准: 单模型流式识别 | 混合: +SenseVoice 离线校正",
    "config.model": "模型:",
    ...
    "config.tencentUsage": "累计使用:",
    "config.tencentConsoleLink": "腾讯云语音识别控制台",
    "config.hours": "小时",
    "config.minutes": "分",
    "config.seconds": "秒",
    "config.kbOnly": "键盘",
    "config.overlay": "浮窗",
    "config.vrHud": "VR HUD",
    "config.vadOn": "VAD: 语音中",
    "config.vadOff": "VAD: 静音",
    ...
    "config.providerLocalEmbeddedShort": "本地嵌入式",
    "config.providerLocalShort": "远程STT",
    "config.providerTencentShort": "腾讯云",
    "config.vadEnable": "启用端点检测",
    "config.vadRule1": "句子边界静音 (秒)",
    "config.vadRule2": "子短语边界静音 (秒)",
    "config.vadRule3": "最短发声长度 (秒)",
    "config.tabSpeech": "语音设置",
    "config.tabVad": "VAD",
    "config.tabMaintenance": "维护",
    "config.onnxProvider": "推理后端",
    "config.resetDefaults": "恢复默认设置",
    "config.deleteModels": "删除已下载模型",
  ...
  en: {
    ...
    "test.count": "{} recording(s)",
    "test.noRecordings": "No recordings",
    ...
    "config.backendStandard": "Standard",
    "config.backendHybrid": "Hybrid",
    "config.backendHint": "Standard: single-model streaming | Hybrid: +SenseVoice refinement",
    "config.model": "Model:",
    ...
    "config.tencentUsage": "Usage:",
    "config.tencentConsoleLink": "Tencent Cloud ASR Console",
    "config.vadOn": "VAD: Speech",
    "config.vadOff": "VAD: Silence",
    "config.hours": "hours",
    "config.minutes": "min",
    "config.seconds": "s",
    "config.kbOnly": "Keyboard Only",
    ...
    "config.providerLocalEmbeddedShort": "Local Embedded",
    "config.providerLocalShort": "Remote STT",
    "config.providerTencentShort": "Tencent Cloud",
    "config.vadEnable": "Enable endpoint detection",
    "config.vadRule1": "Sentence silence (s)",
    "config.vadRule2": "Sub-phrase silence (s)",
    "config.vadRule3": "Min utterance (s)",
    "config.tabSpeech": "Speech",
    "config.tabVad": "VAD",
    "config.tabMaintenance": "Maintenance",
    "config.onnxProvider": "ONNX Provider",
    "config.resetDefaults": "Reset defaults",
    "config.deleteModels": "Delete models",
